...
* Download the most up-to-date version of this book from this repository
  - day-one-containers-kubernetes-contrail-v1.pdf (version v1, this is the one available in the official channels)
  - day-one-containers-kubernetes-contrail-v1.1pdf (version v1.1, with some corrections on TOC only)
...
* besides the above, in this github repository you'll also find:
  - day-one-containers-kubernetes-contrail.adoc: this is "source code" of the
    original draft of the whole book, the way we've writen/modified it.
  - day-one-containers-kubernetes-contrail.html: same, but in html format, with a TOC
...
* pdf  `day-one-containers-kubernetes-contrail-v1.1.pdf` (some corrections to PDF bookmarks only)
